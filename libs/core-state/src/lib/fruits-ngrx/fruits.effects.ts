...
import { Fruit, FruitsService, NotifyService } from '@ngrx-fruits/core-data';
    ...
    this.dataPersistence.fetch(fruitsActions.loadFruit, {
      run: (
        ...
        return this.fruitsService
          ...
          .pipe(map((fruit: Fruit) => fruitsActions.fruitLoaded({ fruit })));
      },
      onError: (action: ReturnType<typeof fruitsActions.loadFruit>, error) => {
  ...
  createFruit$ = createEffect(() =>
    this.dataPersistence.pessimisticUpdate(fruitsActions.createFruit, {
      run: (
        ...
        return this.fruitsService
          .create(action.fruit)
          .pipe(map((fruit: Fruit) => fruitsActions.fruitCreated({ fruit })));
      },
      onError: (
        action: ReturnType<typeof fruitsActions.createFruit>,
        error
  ...
  updateFruit$ = createEffect(() =>
    this.dataPersistence.pessimisticUpdate(fruitsActions.updateFruit, {
      run: (
        ...
        return this.fruitsService
          .update(action.fruit)
          .pipe(map((fruit: Fruit) => fruitsActions.fruitUpdated({ fruit })));
      },
      onError: (
        action: ReturnType<typeof fruitsActions.updateFruit>,
        error
  ...
  deleteFruit$ = createEffect(() =>
    this.dataPersistence.pessimisticUpdate(fruitsActions.deleteFruit, {
      run: (
        ...
        return this.fruitsService
          .delete(action.fruit)
          .pipe(map(() => fruitsActions.fruitDeleted({ fruit: action.fruit })));
      },
      onError: (
        action: ReturnType<typeof fruitsActions.deleteFruit>,
        error
